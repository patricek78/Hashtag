...
if (isset($_POST['valid_connect']) && $_POST['valid_connect'] == 'Envoyer') {
	...
	if ((isset($_POST['crea_login']) && !empty($_POST['crea_login'])) && (isset($_POST['crea_pwd']) && !empty($_POST['crea_pwd'])) && (isset($_POST['crea_pwd_verif']) && !empty($_POST['crea_pwd_verif'])) && (isset($_POST['date_debut']) && !empty($_POST['date_debut'])) && (isset($_POST['date_fin']) && !empty($_POST['date_fin'])) ) {
